...
本目录记录当前项目可直接复用的操作手册，来源参考了 `D:\Coding\Jibai\docs`
里的通用方法，但已经按 `OdailySeer` 的真实目录结构和命令做了适配。

## 文档列表

- [项目结构说明](D:/Coding/OdailySeer/docs/project-structure.md)
...
- Linux systemd 部署文件：`backend/systemd/`
